# Generated by Powerlevel10k configuration wizard on 2020-12-07 at 09:19 CET.
...
# flat tails, 2 lines, dotted, left frame, compact, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE="%n@$SSH_HOST"
