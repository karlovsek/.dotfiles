...
export MANPAGER="vim -c 'set ft=man ts=8 nomod nolist nonu nornu buftype=nofile noswapfile nobackup | silent %s/\e\[4m//g | silent %s/\e\[24m//g  | AnsiEsc' -c 'normal gg' --not-a-term -"
